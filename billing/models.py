...
class Transaction(models.Model):
    """
    Records a completed or pending purchase. Every successful purchase should create
    one or more Entitlement rows in the same transaction.
    """
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["reference", "amount"]),
        ]

    def mark_completed(self, completed_at: datetime.datetime = None):
